...
#define KEYWORDS_RE       ";|->|\\+|-|\\*|,|=|!=|\\[|\\]|\\(|\\)|\\{|\\}|STARTPROGRAM|VARIABLE|STARTBLOCK|ENDBLOCK|INPUT|OUTPUT|IF|ELSE|FOR|DOWNTO|DO|DIV|MOD|<<|>>|!!|&&|\\|\\||INT16"


#define IDENTIFIERS_RE    "_[a-z][0-9][a-z]"
...
{ LA_IS, { T_NAME_0 }, { "program_rule",{\
    { LA_IS, {""}, 9, { T_NAME_0, T_SEMICOLON_0, T_BODY_0, T_DATA_0, "declaration__optional", T_SEMICOLON_0, "statement__iteration", T_END_0 }}\
}}},\
...
{ LA_IS, { T_NAME_0 }, { "program____part1",{\
    { LA_IS, {""}, 7, { T_NAME_0, T_SEMICOLON_0, T_BODY_0, T_DATA_0, "declaration_optional", T_SEMICOLON_0 }}\
}}},\
\
},\
"program_rule"
